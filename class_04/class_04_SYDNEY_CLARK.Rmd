...
#Rows (observations) - 290,908; Columns (variables) - 42

#$ DRUG_CODE (dbl) not needed b/c it's repetitive; chr example -  $ UNIT - just gives null values; missing values are shown as null
